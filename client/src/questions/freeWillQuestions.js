...
export const freeWillQuestions = (answers,theses,classDay) => [

    {
        questionId: "fw1", questionText: 'What is the meaning of life?', questionType: 'Radio', questionOptions: ['To love and be loved', 'To be happy'],
