...
import StaticAnswersForPDF from './components/StaticAnswersForPDF'; // Adjust the path as necessary
import './App.css';
    ...
    <Router>
      <div className="app-container" style={appStyle}>
        <Routes>
          ...
          <Route path="/showAllAnswers/:username" element={<StaticAnswersForPDF />} />
          <Route path="/" element={
            <>
